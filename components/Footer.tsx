...
const serviceLinks = [
  { href: "#services", label: "Business Website" },
  { href: "#services", label: "Online Store" },
  { href: "#services", label: "Clinic Website" },
  { href: "#services", label: "Restaurant Page" },
  { href: "#services", label: "Google My Business" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 text-[15px] leading-[1.7] text-white/70 max-w-md">
              ...
              websites banata hai. Hum aapke paas aate hain, aapki boli samajhte hain, aur tez delivery
              dete hain — seedhe, imaandaar pricing ke sath.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <SocialIcon label="WhatsApp" href={`https://wa.me/${WHATSAPP_E164}`}>
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-gold font-semibold text-[15px]">Quick Links</h3>
            <ul className="mt-4 space-y-2.5">
              {quickLinks.map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="text-[14px] text-white/70 hover:text-white transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-2">
            <h3 className="text-gold font-semibold text-[15px]">Services</h3>
            <ul className="mt-4 space-y-2.5">
              {serviceLinks.map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="text-[14px] text-white/70 hover:text-white transition-colors">
          ...
          <div className="lg:col-span-3">
            <h3 className="text-gold font-semibold text-[15px]">Newsletter</h3>
            <p className="mt-3 text-[14px] leading-relaxed text-white/65">
              Tips for local SEO, WhatsApp marketing, aur website ideas — kabhi kabhi email.
            </p>
            <NewsletterForm />
            <div className="mt-8 space-y-2 text-[14px] text-white/65">
              <p>{CONTACT.address}</p>
              <p>
